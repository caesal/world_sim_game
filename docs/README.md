...
For Ver0.2.6.a, the current official docs are:

- `docs/official/game_universal_documentation_ver0.2.6.a.doc`
- `docs/official/versions/game_doc_ver0.2.6.a.doc`
- `docs/official/versions/game_doc_ver0.2.6.a_change_summary.doc`
