...
For Ver0.2.6.b, the current official docs are:

- `docs/official/game_universal_documentation_ver0.2.6.b.doc`
- `docs/official/versions/game_doc_ver0.2.6.b.doc`
- `docs/official/versions/game_doc_ver0.2.6.b_change_summary.doc`
