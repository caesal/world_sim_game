...
extern int selected_alliance_id;
extern int alliance_list_scroll_offset;
extern int alliance_detail_scroll_offset;
extern int alliance_detail_subtab;
extern int alliance_detail_scroll_offsets[ALLIANCE_DETAIL_TAB_STORAGE_COUNT];
extern int alliance_member_sort_column;
