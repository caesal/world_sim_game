...
int debug_subtab = DEBUG_SUBTAB_MAP_LOG;
int debug_system_scroll_offset = 0;
...
const int MAP_DISPLAY_MODES[MAP_DISPLAY_MODE_COUNT] = {
    DISPLAY_POLITICAL, DISPLAY_ALLIANCE, DISPLAY_GEOGRAPHY,
