...
void draw_worldgen_progress_overlay(HDC hdc, RECT client) {
    ...
    format_percent(pct, sizeof(pct), progress.displayed_overall_progress_units);
    ...
    draw_progress_bar(hdc, overall_bar, progress.displayed_overall_progress_units, RGB(103, 164, 196));
